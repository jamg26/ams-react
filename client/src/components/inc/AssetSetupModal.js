...
class AssetSetup extends React.Component {
    ...
    render (){
        return [
            ...
            {this.state.reference==1? <AssetSetupForm data={this.props.data.length!=0? this.props.data : []} /> : <SiteAndLocationFrom data={this.props.data.length!=0 && this.state.reference==2? this.props.data : []} />}
