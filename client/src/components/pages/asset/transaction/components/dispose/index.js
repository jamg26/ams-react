...
const Dispose = (props) => {
  ...
  const columns = [
    ...
    {
      title: 'Due Date for Maintenance',
      dataIndex: '',
    },
    {
      title: 'Note',
        ...
        <Form {...layout} name='basic' onFinish={onFinish} fields={selected}>
          <Row>
            ...
            <Col md={15}>
              ...
              <Form.Item label='Dispose Reason' name='dispose_reason'>
                <Select>
              ...
              <Form.Item label='Note' name='dispose_note'>
                <TextArea />
              </Form.Item>
              <Button style={{ float: 'right' }}>Dispose</Button>
            </Col>
          </Row>
        </Form>
      </Card>
      <Card title='Asset on Maintenance'>
