...
class NewRequest extends React.Component {
    ...
    searchfunction =(value) => {
        ...
        table = document.getElementById("denied_asset_table");
    ...
    get_asset_setup_list = async () => {
        ...
        const response = await axios.get(api_base_url + '/api/data_entry_officer_pending_request', {
          headers: headers,
        });
        ...
        return [
            <div>
                <Row gutter="16">
                    ...
                    /> : null}
                    <table className="table table-sm" id="denied_asset_table">
                        <thead >
                        <tr style={{backgroundColor : '#083240', color :'white'}}>
                            <th colSpan="9" style={{verticalAlign : 'middle',textAlign : 'center'}}>DENIED REQUEST</th>
                        </tr>
