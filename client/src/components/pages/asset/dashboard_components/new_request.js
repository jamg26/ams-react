...
class NewRequest extends React.Component {
    ...
    searchfunction =(value) => {
        ...
        table = document.getElementById("asset_management_officer_approval_table");
    ...
    get_asset_setup_list = async () => {
      ...
      const response = await axios.get(api_base_url + '/api/asset_management_officer_pending_request', {
        headers: headers,
      });
    ...
    approve_request= async (id, ticket_no, type)=>{
        ...
        if(type=="NEW_ASSET"){
            ...
            alert('[temporary alert] new asset request approved');
            this.get_asset_setup_list();
            ...
            alert('[temporary alert] new asset setup request approved');
            this.get_asset_setup_list();
        }
    }
        ...
        return [
            <div>
                <Row gutter="16">
                    ...
                    /> : null }
                    <table className="table table-sm" id="asset_management_officer_approval_table">
                        <thead >
                        <tr style={{backgroundColor : '#083240', color :'white'}}>
                            <th colSpan="9" style={{verticalAlign : 'middle',textAlign : 'center'}}>ASSET MANAGEMENT OFFICER APPROVAL</th>
                        </tr>
